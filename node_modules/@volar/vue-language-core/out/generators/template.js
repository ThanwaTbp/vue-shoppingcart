        ...
        if (vueCompilerOptions.jsxTemplates) {
            ...
            if (_isIntrinsicElement) {
                for (const offset of tagOffsets) {
                    ...
                    writePropertyAccess(node.tag, offset, Object.assign(Object.assign({}, capabilitiesSet.tagReference), capabilitiesSet.tagHover));
                    codeGen.push(`;\n`);
                }
    ...
    function writeImportSlots(node, parentEl, slotBlockVars) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                if (isStatic) {
                    writePropertyAccess(slotName, argRange, Object.assign(Object.assign({}, capabilitiesSet.slotName), { completion: !!prop.arg }));
                }
                else {
                    codeGen.push(`[`);
